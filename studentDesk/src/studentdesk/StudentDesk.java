 ...
 * @author infinite
 */
public class StudentDesk extends javax.swing.JFrame{
...
/** Creates new form Dashboard */
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/studentdesk/index.jpeg"))); // NOI18N
...
dcr.in(cr);
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StudentDesk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
               ...
               new StudentDesk().setVisible(true);
            }
        });
